        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <h4 class="card-title">Listado de Familia Producto
                    ...
                    <button class="btn btn-primary btn-round ml-auto" onClick="$('#envio_search').trigger('reset'); "
                        data-toggle="modal" data-target="#modal_familiaproducto">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="datatable_familiaproducto" class="display table table-striped table-hover">
                        <thead>
                            <tr>
                                <th scope="col">Id</th>
                                <th scope="col">Nombre</th>
                                <th scope="col">Iniciales de nombre</th>
                                <th scope="col">Iniciales de codigo</th>
