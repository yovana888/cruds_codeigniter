        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <h4 class="card-title">Listado Modulos del Sistema</h4>
                    <button class="btn btn-primary btn-round ml-auto" onClick="$('#envio_search').trigger('reset'); "
					data-toggle="modal" data-target="#modal_modulosistema">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="datatable_modulosistema" class="display table table-striped table-hover">
                        <thead>
                            <tr>
								<th>Id</th>
