        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <button class="btn btn-primary btn-round ml-auto" onClick="$('#envio_search').trigger('reset'); "
                        data-toggle="modal" data-target="#modal_unidadmedida">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="datatable_unidadmedida" class="display table table-hover">
                        <thead>
                            <tr>
                                <th scope="col">Id</th>
                                <th scope="col">Codigo SUNAT</th>
                                <th scope="col">Unidad de Medida SUNAT</th>
                                <th scope="col">Abrev.SUNAT</th>
                                <th scope="col">Unidad de Medida COMERCIAL</th>
                                <th scope="col">Abrev.Comercial</th>
